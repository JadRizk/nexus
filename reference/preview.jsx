...
function useFocusTrap(active, onDismiss) {
  ...
  useEffect(() => {
    ...
    const focusables = () => Array.from(node?.querySelectorAll(SEL) ?? []).filter(
...
function rankItems(items, query, limit = 40) {
  ...
  for (const it of items) {
    ...
    else if (name.includes(`_${needle}`) || name.includes(`#${needle}`) || name.includes(` ${needle}`))
      score = 65;
    else if (name.includes(needle)) score = 50;
    else if (String(it.code ?? "").toLowerCase().startsWith(needle))
      score = 45;
    else continue;
...
function CommandPalette({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      ), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "nx-palette__count" }, hits.length)), /* @__PURE__ */ React.createElement(HazardRule, { className: "nx-palette__rule" }), /* @__PURE__ */ React.createElement("div", { className: "nx-sr", role: "status", "aria-live": "polite" }, hits.length, " result", hits.length === 1 ? "" : "s"), hits.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "nx-palette__empty" }, emptyLabel), /* @__PURE__ */ React.createElement(
        "ul",
        {
          ref: listRef,
          id: listId,
...
function NexusProvider({
  ...
  return /* @__PURE__ */ React.createElement(Ctx.Provider, { value: { theme: t, crt: c, setTheme, setCrt } }, /* @__PURE__ */ React.createElement(
    "div",
    {
...
function ToggleRow({ checked, onChange, icon, label, meta, style }) {
  return /* @__PURE__ */ React.createElement("label", { className: "nx-row", "data-checked": checked ? "1" : "0", style }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
      className: "nx-sr",
  ...
  ), icon, /* @__PURE__ */ React.createElement("span", { className: "nx-row__label" }, label), meta != null && /* @__PURE__ */ React.createElement("span", { className: "nx-row__meta" }, meta));
}
...
.nx-root ::-webkit-scrollbar {
  width: 6px;
  height: 6px;
}

.nx-root ::-webkit-scrollbar-thumb {
...
[data-nx-crt="off"] .nx-crt::before {
  display: none !important;
}

[data-nx-crt="off"] .nx-crt-split {
  text-shadow: none;
}
...
.nx-panel[data-nx-corners*="tl"] {
  --tl: var(--nx-border-accent);
}

.nx-panel[data-nx-corners*="tr"] {
  --tr: var(--nx-border-accent);
}

.nx-panel[data-nx-corners*="bl"] {
  --bl: var(--nx-border-accent);
}

.nx-panel[data-nx-corners*="br"] {
  --br: var(--nx-border-accent);
}
...
.nx-panel[data-nx-corners]:not([data-nx-corners="none"])::before {
  ...
  background-size:
    var(--nx-tick) var(--nx-hairline),
    var(--nx-hairline) var(--nx-tick),
    var(--nx-tick) var(--nx-hairline),
    var(--nx-hairline) var(--nx-tick),
    var(--nx-tick) var(--nx-hairline),
    var(--nx-hairline) var(--nx-tick),
...
.nx-tab {
  ...
  cursor: pointer;
  transition:
    color var(--nx-dur-micro),
    background var(--nx-dur-micro);
}
...
.nx-row:hover {
  background: var(--nx-row-hover-bg, var(--nx-bg-hover));
}
...
.nx-wordmark {
  ...
  text-shadow:
    2px 0 var(--nx-split-r),
    -2px 0 var(--nx-split-b);
}
